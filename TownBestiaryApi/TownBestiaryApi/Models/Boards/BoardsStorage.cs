...
public class BoardsStorage {
	public static List<Board> Boards { get; } = new() {
		new Board {
			...
			Latitude = 19.912249m,
			SpeciesId = SpeciesGenerator.Species.Skip(6 - 1).First().Id 
		},
		new Board {
			Id = 2, 
		...
		new Board {
			...
			Longitude = 50.0654m,
			Latitude = 19.9690m,
			SpeciesId = SpeciesGenerator.Species.Skip(2).First().Id 
		},
		new Board {
			Id = 4, 
			Name = "Sowa huhu", 
			...
			Longitude = 50.0694m,
			Latitude = 19.9419m,
			SpeciesId = SpeciesGenerator.Species.Skip(7 - 1).First().Id 
		},
		new Board {
			Id = 5, 
			Name = "Jeżyk Kasia", 
		...
		new Board {
			...
			Longitude = 50.0404m,
			Latitude = 19.8797m,
			SpeciesId = SpeciesGenerator.Species.Skip(5 - 1).First().Id 
		},
		new Board {
			Id = 7, 
			...
			Longitude = 50.0415m,
			Latitude = 19.9496m,
			SpeciesId = SpeciesGenerator.Species.Skip(2 - 1).First().Id 
		},
		new Board {
			Id = 8, 
			...
			Longitude = 50.0415m,
			Latitude = 19.9496m,
			SpeciesId = SpeciesGenerator.Species.Skip(3 - 1).First().Id 
		}
	};
}